...
author: "Amber Camp (notated by Calvin Small)"
date: "2025-09-08"
format: html
editor: visual
---
...
head(mtcars)
# displays the top few lines of the dataframe
...
-   How many rows and columns are in the dataframe? 12, 13 if you count the index
-   What variables look interesting? gear, many of the cars only have three forward gears
-   How might you view the last few rows of the dataframe with a single function? tail(mtcars)
...
plot(mtcars$cyl, mtcars$qsec,
     ...
     ylab = "Time to 1/4 mile",
     main = "Speed against cylinder correlation")
boxplot(mtcars$am, mtcars$qsec,
        xlab = "Transmission Type",
        ylab = "Time to 1/4 mile", 
        main = "Speed against transmission correlation")

hist(mtcars$hp, main = "Horsepower")
```
