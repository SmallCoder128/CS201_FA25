...
Answer: histogram counts for a numeric value variable and a bar plot counts categorical variables
...
```{r, message=FALSE}
ggplot(pokedata, aes(x = sp_atk, y = type_2)) + 
  geom_boxplot() + 
